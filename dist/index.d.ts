...
export declare class VTools {
    ...
    static join_array(array: any[]): string | undefined;
    static join_array2d(array2d: any[]): string | undefined;
    static join_array_of_hashes_values(arrayOfHashes: any[]): string | undefined;
    static smart_array2d_values(array2d: any[]): any[];
    static smart_array_values(array: any[]): any[];
    static smart_hash_values(hash: any): any;
    static hash_to_lines(hash: any): any;
    static hashes_to_lines(hashes: any[]): string | any[];
    static smart_array_of_hash_values(arrayOfHashes: any[]): any[];
    static smart_format_value(v: any): string;
    ...
    static hasRangeOverlap(range1: [number, number], range2: [number, number], options?: {}): boolean;
    static jsFormat(val: any, fns?: any): any;
    static jsFormatVField(val: string | number, vFieldHelp?: any, formatterKeys?: any[]): any;
